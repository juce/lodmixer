...
BYTE XBOX_SIG1[][16] = {
    {0x58,0x42,0x45,0x48,0x61,0x50,0x4f,0xc4,0xe6,0xd0,0x1b,0x76,0x52,0x89,0x9d,0x0e},
...
BYTE XBOX_SIG2[][57] = {
    {0x57,0,0x69,0,0x6e,0,0x6e,0,0x69,0,0x6e,0,0x67,0,0x20,0,
     0x45,0,0x6c,0,0x65,0,0x76,0,0x65,0,0x6e,0,0x20,0,0x38,0,
     0x20,0,0x49,0,0x6e,0,0x74,0,0x65,0,0x72,0,0x6e,0,0x61,0,
     0x74,0,0x69,0,0x6f,0,0x6e,0,0x61},
...
int GetGameVersion(char* filename)
{
    ...
    if (memcmp(buf1, XBOX_SIG1[0], 16)==0 && memcmp(buf2, XBOX_SIG2[0], 57)==0) {
    ...
    if (memcmp(buf1, XBOX_SIG1[2], 16)==0 && memcmp(buf2, XBOX_SIG2[2], 38)==0) {
        return sizeof(GAME_GUID)/sizeof(char*) + 2;
    }
    if (memcmp(buf1, XBOX_SIG1[3], 16)==0 && memcmp(buf2, XBOX_SIG2[3], 57)==0) {
        return sizeof(GAME_GUID)/sizeof(char*) + 3;
    }
